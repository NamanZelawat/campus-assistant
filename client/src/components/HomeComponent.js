...
const items = [
  {
    ...
    caption: "Go cashless for all bookings, fines etc."
  },
  {
    id: 1,
    altText: "Auction",
  ...
  render() {
        ...
        <div className="col-12 col-md-4 mt-2 mb-2">
          <Card>
            <CardImg
              ...
              height="200"
              src={
                "https://click-ism.s3.us-east-2.amazonaws.com/" +
      ...
      return (
        ...
        >
          ...
          <CarouselCaption
            ...
            style={{ fontWeight: "bold", fontSize: "72", color: "black" }}
          />
        </CarouselItem>
      );
    });
    ...
    return (
      <div className="container align-self-center">
        ...
        <div className="heading row row-content">
          <h2> About</h2>
          <p>
